        ...
        <Dialog.Content className='p-2 z-50 rounded fixed bg-white h-[80%] w-1/2 overflow-y-scroll top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <p className='w-full h-auto'>
              Ao acessar ao site Anatonelly LLC, concorda em cumprir estes
            ...
            <p className='w-full h-auto'>
              ...
              materiais (informações ou software) no site Anatonelly LLC, apenas
            ...
            <div className='pl-5'>
              ...
              <li>
                ...
                software contido no site Anatonelly LLC;
              </li>
              <li>
            ...
            <p className='w-full h-auto'>
              ...
              dessas restrições e poderá ser rescindida por Anatonelly LLC a
            ...
            <div className='pl-5'>
              <li>
                Os materiais no site da Anatonelly LLC são fornecidos como
                estão. Anatonelly LLC não oferece garantias, expressas ou
              ...
              <li>
                Além disso, a Anatonelly LLC não garante ou faz qualquer
            ...
            <h1>4. Limitações</h1>
            <p className='w-full h-auto'>
              Em nenhum caso a Anatonelly LLC ou seus fornecedores serão
              ...
              Anatonelly LLC, mesmo que Anatonelly LLC ou um representante
              autorizado da Anatonelly LLC tenha sido notificado oralmente ou
              por escrito da possibilidade de tais danos. Como algumas
              jurisdições não permitem limitações em garantias implícitas, ou
              limitações de responsabilidade por danos consequentes ou
              incidentais, essas limitações podem não se aplicar a você.
            </p>
            <h1>5. Precisão dos materiais</h1>
            <p className='w-full h-auto'>
              Os materiais exibidos no site da Anatonelly LLC podem incluir
              erros técnicos, tipográficos ou fotográficos. Anatonelly LLC não
              garante que qualquer material em seu site seja preciso, completo
              ou atual. Anatonelly LLC pode fazer alterações nos materiais
              contidos em seu site a qualquer momento, sem aviso prévio. No
              entanto, Anatonelly LLC não se compromete a atualizar os
              materiais.
            </p>
            <h1>6. Links</h1>
            <p className='w-full h-auto'>
              A Anatonelly LLC não analisou todos os sites vinculados ao seu
              site e não é responsável pelo conteúdo de nenhum site vinculado. A
              inclusão de qualquer link não implica endosso por Anatonelly LLC
              do site. O uso de qualquer site vinculado é por conta e risco do
              usuário.
            </p>
            <p className='w-full h-auto'>Modificações</p>
            <p className='w-full h-auto'>
              A Anatonelly LLC pode revisar estes termos de serviço do site a
