        ...
        <Dialog.Content className='p-2 rounded fixed bg-white h-[80%] w-1/2 overflow-y-scroll top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]'>
          ...
          <div className='flex flex-col gap-5'>
            <p className='w-full h-auto'>
              A sua privacidade é importante para nós. É política da Anatonelly
              LLC respeitar a sua privacidade em relação a qualquer informação
              sua que possamos coletar no site Anatonelly LLC, e outros sites
            ...
            <p className='w-full h-auto'>
              ...
              informação que a Anatonelly LLC oferece no site e com caráter
            ...
            <div className='pl-5'>
              ...
              <li>
                ...
                (softwares) da Anatonelly LLC, de seus fornecedores ou
